...
def get_tweets(handle):
    query = urllib.quote_plus('from:'+handle+'since:2017-02-18 include:retweets')
    tweets = []
    browser = anonBrowser()
    browser.anonymize()
